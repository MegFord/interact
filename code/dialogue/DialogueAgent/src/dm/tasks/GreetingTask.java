...
public class GreetingTask extends Task
{
	...
	public String question,inFields,outField,responsePattern, mood;
	
	public GreetingTask(String name,Properties properties)
	{
	...
	public void setMandatoryFields() {
		...
		mandatoryFields[4] = "mood"; //what mood the user's response sets 
	}
	...
	public void init() {
		...
		mood = properties.getProperty("mood");
