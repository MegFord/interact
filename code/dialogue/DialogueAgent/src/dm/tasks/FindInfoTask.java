...
public class FindInfoTask extends Task
{
	...
	public void setMandatoryFields() {
		...
		mandatoryFields[0] = "question"; // The question(s) to ask to find this out
		mandatoryFields[1] = "inFields"; //comma separated <space:field> fields to use in the response pattern
		mandatoryFields[2] = "outField"; //which field is the question going space:field
		mandatoryFields[3] = "responsePattern"; // In case the DM wants to display a response...
	}
